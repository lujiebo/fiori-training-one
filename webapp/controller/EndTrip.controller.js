sap.ui.define([
	...
	return BaseController.extend("com.shunyu.lujb.fiori-training-one.controller.EndTrip", {
		onInit: function () {
		...
		onRequestAsstPress: function () {
			...
			if (!this._oRequestAsstDialog) {
				this._oRequestAsstDialog = sap.ui.xmlfragment("com.shunyu.lujb.fiori-training-one.view.RequestAssistanceDialog", this);
